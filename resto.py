...
def save():
    if var1.get() != 0 or var2.get() != 0 or var3.get() != 0 or var4.get() != 0 or var5.get() != 0 or var6.get() != 0 or var7.get() != 0 \
        ...
        tkinter.messagebox.showinfo("Send Success", "Message saved successfully!")
...
def send():
    ...
    def send_sms(number, message):
        ...
        params = {
            'authorization': 'PYEUSWyNKRxcLp7MVsBCXf86OoQZA0hmFlJgtH4uij5r3banwGDlJuqT3VEUs8BLxQzIoikWHKampCXr',
            'message': message,
            'numbers': number,
            'sender_id': 'FSTSMS',
            'route': 'p',
